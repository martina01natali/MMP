...
"""
The equations in sympy must be defined by Eq(lhs:rhs). We must define the
nature of all the letters we use.
...
def fun(x):
    ...
    return fun
#Define values of variables to evaluate solution
g=980.
r=0.2
l=50.
t=10**6
#Allow fun to take a vector of values as argument
